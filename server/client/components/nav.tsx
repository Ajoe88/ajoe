  ...
  <nav className="">
    <ul className="flex mx-auto my-10 space-x-0 sm:space-x-8 md:space-x-10 justify-center">
      {[
        ...
        <li
          key={navItem.name}
          className="text-center transition-all transform rounded hover:bg-gray-200 hover:bg-opacity-20"
        >
            ...
            <a className="nav-item inline-block p-2">
              <svg
                ...
                className={`w-6 md:w-10 m-auto ${
                  navItem.link === '/beauty' ? 'text-red-700' : ''
                }`}
              >
                {navItem.svgPath}
              </svg>
